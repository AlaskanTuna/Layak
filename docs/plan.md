...
**Exit criteria:** /dashboard/schemes shows 6 in-scope cards (3 original + 3 new) above 2 coming cards; all copy is mirrored across en/ms/zh; build is green. _(Met with one deviation: 5 in-scope cards (3 original + JKM BKK + PERKESO SKSPS) above 4 coming cards. i-Saraan card deferred until Phase 7 Task 7 ships the backend rule.)_
