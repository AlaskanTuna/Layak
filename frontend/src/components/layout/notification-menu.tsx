  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      <div
        ...
        aria-hidden={!isOpen}
        className={cn(
          'absolute right-0 top-full z-50 mt-2 w-80 max-h-[400px] overflow-x-hidden overflow-y-auto rounded-xl border border-border bg-card shadow-[0_18px_48px_-12px_rgb(15_23_42/0.18)] dark:shadow-[0_18px_48px_-12px_rgb(0_0_0/0.55)]',
