...
- [ ] Update `docs/trd.md` §5.1 + §7 to replace every `GEMINI_API_KEY` reference with the Vertex AI ADC + project-based auth flow. _(Queued separately with the `.env.example` cleanup task; no `docs/trd.md` sweep landed in this cutover.)_
