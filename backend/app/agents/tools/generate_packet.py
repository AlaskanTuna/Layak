...
_TEMPLATE_MAP: dict[str, tuple[str, str]] = {
    "str_2026": ("bk01.html.jinja", "BK-01-STR2026-draft-{ic_last6}.pdf"),
    "jkm_warga_emas": ("jkm18.html.jinja", "JKM18-warga-emas-draft-{ic_last6}.pdf"),
    "jkm_bkk": ("jkm_bkk.html.jinja", "JKM-bkk-draft-{ic_last6}.pdf"),
    "lhdn_form_b": ("lhdn.html.jinja", "LHDN-form-b-relief-summary-{ic_last6}.pdf"),
    "lhdn_form_be": ("lhdn_be.html.jinja", "LHDN-form-be-relief-summary-{ic_last6}.pdf"),
    "perkeso_sksps": ("perkeso_sksps.html.jinja", "PERKESO-sksps-draft-{ic_last6}.pdf"),
    "i_saraan": ("i_saraan.html.jinja", "KWSP-i-saraan-draft-{ic_last6}.pdf"),
}
...
_LOCALE_STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "filer_ic_label": "Filer IC (last 6):",
    ...
    "ms": {
        ...
        "filer_ic_label": "IC Pemfail (6 akhir):",
...
def _render_draft(
    ...
    filename = filename_pattern.format(ic_last6=profile.ic_last6)
