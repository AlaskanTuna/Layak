...
# Layak's added "review and submit manually" copy on the DRAFT packets. The
# gov-form body keeps its source language (BK-01 is BM, the LHDN forms are
# EN-leaning) because the user transcribes them verbatim onto the live
# portal; only the Layak-added review footer localises. The watermark
# "DRAFT — NOT SUBMITTED" is intentionally kept English across languages —
# three universally-recognised words, matches demo screenshots.
_LOCALE_STRINGS: dict[str, dict[str, str]] = {
    ...
    "ms": {
        "draft_footer": (
            ...
            "Layak dan ditandakan \"DRAFT — NOT SUBMITTED\" pada setiap muka "
    ...
    "zh": {
        "draft_footer": (
            ...
            "\"DRAFT — NOT SUBMITTED\" 水印。Layak 并非政府官方服务，与任何马来"
