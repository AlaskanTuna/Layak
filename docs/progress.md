...
- **Verified**: `pnpm -C frontend build` passes; `pytest -q` in `backend/` passes all 39 rule-engine tests (backend untouched); `docs/trd.md` §9.6 marked RESOLVED pointing at `frontend/public/demo/` in the earlier pushed commit.
